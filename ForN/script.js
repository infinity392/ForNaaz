...
function finalRedirect() {
    // Redirect to the desired page after the animation ends
    window.location.href = "https://www.yourfinalpage.com";  // Change to your desired URL
  }

  // Set a delay after all animations are complete to trigger the redirect
  setTimeout(finalRedirect, 55000);  // 10 seconds after the last animation, adjust as necessary
